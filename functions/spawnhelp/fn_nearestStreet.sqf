...
/* -----------------------------------------------------------------------------------------------
Function: MSOT_spawnhelp_fnc_nearestStreet
...
Examples:
          _streetname = [_position,200] call MSOT_spawnhelp_fnc_nearestStreet;
...
_distance = 0;
_street_arr = [_position,_radius,true] call MFUNC(spawnhelp,getStreets);
